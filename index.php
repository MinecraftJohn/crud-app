<?php 
    ...
    function toastActivate($toast_msg) {
        echo "<script>
...
<body>
    ...
    <div class="toast_container">
        <svg viewBox="0 0 80 80" class="toast_icon">
            <circle cx="40" cy="40" r="40" fill="var(--white)"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M64 27.5367L58.4633 22L33.475 46.9884L21.5367 35.05L16 40.5867L33.473 58.0597L35.8898 55.643L35.8917 55.645L64 27.5367Z" fill="var(--green)"/>
        </svg>
        <p class="toast_msg"></p>
    </div>
    <section>
    ...
    <section>
        ...
        <!-- <span class="delete_data_background">
            test niggah
        </span> -->
